...
import static com.zhongyou.meettvapplicaion.BuildConfig.DEBUG;

public class FocusBorderView extends View {

	private static final String TAG = "TvRecyclerView.FB";

	private MyRecyclerView mTvRecyclerView;
	...
	public MyRecyclerView getTvRecyclerView() {
		return mTvRecyclerView;
	}

	public void setTvRecyclerView(MyRecyclerView tvRecyclerView) {
