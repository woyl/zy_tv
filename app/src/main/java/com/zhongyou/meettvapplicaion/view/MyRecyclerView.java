...
import com.zhongyou.meettvapplicaion.utils.ModuleLayoutManager;
...
public class MyRecyclerView extends RecyclerView {
		...
		if (event.getAction() == KeyEvent.ACTION_DOWN) {
			...
			try {
				if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
					if (mOnRightFoucsListener != null) {
						if (mOnRightFoucsListener.onLeftFouces()) {
							return true;
						}
					}
					...
					if (mOnRightFoucsListener != null) {
						if (mOnRightFoucsListener.onRightFoucs()) {
							return true;
						}
					}
	...
	public interface OnRightFoucsListener {
		boolean onRightFoucs();

		boolean onLeftFouces();
	}

	public OnRightFoucsListener mOnRightFoucsListener;

	public void setOnRightFoucsLinstener(OnRightFoucsListener onRightFoucsListener) {
		this.mOnRightFoucsListener = onRightFoucsListener;
	}
