...
public class MeetingLaunchAdapter extends OpenPresenter {
...
//    private int[] colors = new int[]{ R.color.c_e646006a, R.color.c_e600556a, R.color.c_e66a5200 };
	...
	public MeetingLaunchAdapter(Context context, ArrayList<Meeting> meetings) {
...
//        mAdapter.notifyDataSetChanged();
	...
	public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
		...
		holder.bgLayout.setOnKeyListener(new View.OnKeyListener() {
			@Override
		...
		holder.bgLayout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				((MeetingsActivityLaunch) mContext).gotoMeetting(position);
			}
		});

		holder.bgLayout.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			@Override
			public void onFocusChange(View v, boolean hasFocus) {
				((MeetingsActivityLaunch) mContext).mCurrentPosition = position;
			}
		});
