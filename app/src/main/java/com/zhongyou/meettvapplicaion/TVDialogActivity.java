...
public class TVDialogActivity extends Activity implements DialogContract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.e(iconRes+"---"+yesRes+"---"+noRes+"---"+descRes+"---"+titleRes);
    ...
    public static class AlertSelectionFragment extends BaseGuidedStepFragment<DialogContract> {
        ...
        public static AlertSelectionFragment newInstance(int titleRes,int iconRes,String descRes,int yesRes,int noRes) {
...
//        }
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            ...
            String breadcrumb = "";
            String description = Html.fromHtml(getArguments().getString(ARG_DESC_RES)).toString();
            Drawable icon = getActivity().getResources().getDrawable(getArguments().getInt(ARG_ICON_RES));
