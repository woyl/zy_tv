...
//        File mediaStorageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM);
    ...
    public static void mySetDisplayOrientation(Activity activity, int cameraId,android.hardware.Camera camera) { // 调整摄像头方向
        Camera.CameraInfo info = new Camera.CameraInfo();
        Camera.getCameraInfo(cameraId, info);
        Log.e("li_cj","............."+info.orientation + "---------------"+info.facing);
