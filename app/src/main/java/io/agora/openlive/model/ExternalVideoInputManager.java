...
public class ExternalVideoInputManager implements IVideoSource {
    ...
    public ExternalVideoInputManager(BaseApplication application) {
    ...
    private class ExternalVideoInputThread extends Thread {
        ...
        private void prepare() {
            ...
            mApplication.getWorkerThread().getRtcEngine().setVideoSource(ExternalVideoInputManager.this);
        }

        private void release() {
            mApplication.getWorkerThread().getRtcEngine().setVideoSource(null);
            mSurface.release();
